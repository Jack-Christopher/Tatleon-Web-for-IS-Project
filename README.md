...
#### UNIT TEST
Se usó el framework PHPUNIT para las pruebas unitarias de los bloques de codigo, un archivo .php para cada prueba y un archivo tester.py  para el alamacenamiento de los resultados de todos las pruebas en un archivo results.txt
...
#### DEPLOYMENT
Se usó la herramienta NcFTP con protocolo FTP para el despliegue de aplcaciones web en los servidores. Se ejecutaron comandos en lenguaje Batch para desplegar cada uno de las subcarpetas y archivos del proyecto.
